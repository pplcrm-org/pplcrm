...
| lists                     | Smart (self-refreshing rule) and static lists of people or households; rule builder with live count; rules include electoral areas; built-in undeletable All Subscribers / All Volunteers.                                                                |
| forms                     | Public web forms (Signup/Pledge/RSVP/Request/Survey), draft→published→archived, live edit + preview, embed/iframe/API, submissions link-not-overwrite existing people.                                                                                    |
| fundraising               | Donation-page builder (separate from forms because it takes card payments).                                                                                                                                                                               |
| donations                 | Ledger, pledges (recurring), receipts + giving statements, record-a-gift. Stripe Connect: campaign's own Stripe account, merchant of record, 1% platform fee.                                                                                             |
| workflows                 | Automations: triggers (form, person created, tag, list join, donation, shift, SLA breach, new un/subscriber, quiet supporter, manual) + steps (wait, email, tag, task, notify); goals; previous-email gating; relationship vs marketing mail declaration. |
...
| profile / files / summary | Own profile; files + storage quota; dashboard with SLA health + getting-started.                                                                                                                                                                          |
| go-live                   | Wizard out of demo mode: plan, org details, phone verification, sending setup, demo-data removal.                                                                                                                                                         |
