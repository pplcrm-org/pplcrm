  ...
  },
  {
    ...
    blocks: [
      ...
      { kind: 'h2', id: 'anatomy', text: 'Anatomy of an automation' },
      {
        kind: 'list',
        items: [
          '**Trigger** is the one event that lets someone in: Form submitted, Person created, Tag added, List joined, Donation recorded, a billing event, a volunteer shift status, a task breaching its SLA (the person the task is linked to enrolls; tasks that an automation created are not counted, and the same person is enrolled by this trigger at most once a week, so an automation that creates tasks cannot keep re-triggering itself), a new subscriber or unsubscriber, a supporter going quiet (no opens or clicks for a number of days you choose), or plain Manual enrollment. Everything after the trigger is the sequence.',
