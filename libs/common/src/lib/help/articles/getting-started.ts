    ...
    blocks: [
      ...
      { kind: 'h2', id: 'sidebar-map', text: 'The sidebar, section by section' },
      {
        ...
        items: [
          ...
          '**Field**: [Canvassing](/canvassing) (which includes the delivery Requests tab) and [Teams](/teams).',
    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          ...
          '**Field operations** (workspaces with canvassing or deliveries): doors knocked and conversations over the last 7 days, turfs being knocked right now, overall door coverage (doors reached at least once vs every door on your live turfs, with a percentage), sign requests ready to go out, signs delivered in the last 7 days, and volunteers waiting for approval — each one a link to that work. See [Canvassing](/help/canvassing) and [Deliveries](/help/deliveries).',
