    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          ...
          '**Field operations** (workspaces with canvassing or deliveries): doors knocked and conversations over the last 7 days, turfs being knocked right now, sign requests ready to route, and volunteers waiting for approval — each one a link to that work. See [Canvassing](/help/canvassing) and [Deliveries](/help/deliveries).',
