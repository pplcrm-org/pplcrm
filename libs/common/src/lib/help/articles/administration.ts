    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          ...
          '**Modules**: what kind of organization this is — **Constituency office**, **Political campaign**, **Non-profit**, or **Church** — and which optional modules (Canvassing, Deliveries, Donations, Approvals) appear in your sidebar. The organization type only picks the wording and the starting set: a constituency office starts without **Donations**, because a publicly funded office does not fundraise — its riding association does, on separate books. A module the organization type leaves off stays in the sidebar, dimmed, so you can see it exists; clicking it points you back here. A module you switch off yourself leaves the sidebar entirely. Turn any module on here and it reappears immediately. Turning one off never deletes anything, and never blocks a link you already have. Whichever type you pick is shown at the top of your avatar menu, so you can always tell which one a workspace is on; administrators can click it to come straight back here.',
