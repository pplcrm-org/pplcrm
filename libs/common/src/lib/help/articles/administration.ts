    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          ...
          '**App**: how the volunteer-facing apps behave, including whether volunteer links expire after 30 days. Expiry is the secure default (a forwarded or long-lost link goes dead on its own), but you can turn it off if your outings run longer. Volunteers still verify a code and need a one-time approval either way.',
