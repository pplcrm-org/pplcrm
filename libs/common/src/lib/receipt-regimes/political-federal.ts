...
export const POLITICAL_FEDERAL_REGIME: ReceiptRegimeSpec = {
  ...
  registrationNumberLabel: 'Elections Canada registry reference',
  registrationNumberHint: "Optional — the entity as recorded in the Chief Electoral Officer's registry",
