  ...
  blocks: [
    ...
    },
    {
      ...
      items: [
        ...
        'Each plan’s emailable-subscriber limit is enforced at send time too: a Free-plan workspace whose emailable-subscriber count exceeds 1,000 cannot send newsletters until the list is reduced to the limit or the plan is upgraded. Contacts are never deleted by this — the limit applies to sending, not to storage.',
