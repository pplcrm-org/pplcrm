  ...
  campaign: {
    ...
    features: [
      ...
      },
      {
        ...
        body: '611 donors, every gift on its donor’s record and receipted by email the moment it arrives — plus numbered official contribution receipts at year end when your regime allows them. Pledges and running totals without a second spreadsheet.',
      },
      IMPORT_CARD,
    ],
    companionFeatures: [
  ...
  nonprofit: {
    ...
    features: [
      ...
      },
      {
        ...
        body: '611 donors, every gift on its donor’s record and receipted by email as it arrives. Recurring gifts, pledges, year-end official donation receipts and running totals without a second spreadsheet.',
      },
      IMPORT_CARD,
    ],
    companionFeatures: [
  ...
  church: {
    ...
    features: [
      ...
      },
      {
        icon: 'currency-dollar',
        title: 'Giving, gratefully',
        body: 'Tithes, offerings and pledges land on each family’s record — receipted by email as they arrive, and summed at year end into official CRA receipts you can email or print. No second spreadsheet.',
      },
      {
        icon: 'arrow-up-tray',
